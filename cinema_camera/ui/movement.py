...
class MovementWidget:
    ...
    def __init__(self, parent, num: int,
                 mvm: Union[Movement, None] = None) -> None:
        self.parent = parent
        ...
        if not mvm:
            self.movement: Movement = Movement(
                num=num,
                position=bs.Vec3(0, 0, 0),
                target=bs.Vec3(0, 0, 0),
                during_time=1.0,
                speed_graph_cf=1.0,
                speed_move_cf=bs.Vec3(1.0, 1.0, 1.0),
        ...
        self.height = (520 if uiscale is bui.UIScale.SMALL else
                       570 if uiscale is bui.UIScale.MEDIUM else 620)
    ...
    def _update(self):
        ...
        self.position_text = bui.textwidget(
        ...
        self.change_position_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.change_position_graph_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.target_text = bui.textwidget(
            parent=self.root_widget,
        ...
        self.change_target_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.change_target_graph_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.change_time_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.change_time_graph_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.settings_button = bui.buttonwidget(
            parent=self.root_widget,
        ...
        self.cancel_button = bui.buttonwidget(parent=self.root_widget,
        ...
        bui.containerwidget(
            ...
            selected_child=(
                cbtn if cbtn is not None and self.cancel_is_selected else None
            ),
            start_button=None
        )  # select cancel button, if it need

    def _on_change_position_press(self):
        def set_value(value: bs.Vec3) -> None:
    ...
    def _on_change_speed_graph(self):
        ...
        EditNum(self.movement.speed_graph_cf, set_value,
                fields_title=['degree'])
    ...
    def _on_change_move_graph(self):
        ...
        EditVector(self.movement.speed_move_cf, set_value,
                   fields_title=['X degree', 'Y degree', 'Z degree'])

    def _on_settings_press(self):
        bui.screenmessage("Настройки", color=(0.1, 0.8, 0.5))

    def _save(self) -> None:
        bui.screenmessage(f"Successfully add movement #{self.num}",
                          color=(0.4, 0.3, 0.9))
